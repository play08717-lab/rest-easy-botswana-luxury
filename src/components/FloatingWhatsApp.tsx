  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex items-center gap-3">
      <a
        ...
        className="flex h-12 w-12 items-center justify-center rounded-full border border-gold/40 bg-dark/90 text-gold shadow-2xl backdrop-blur-md transition-transform duration-300 hover:scale-105 hover:bg-gold hover:text-dark"
      >
